...
//Let's simulate a heap using a SortedDictionary
//Passing the sorteddictionary to a list is to heavy too
...
{
    class HeapsFindRunningMediaSortedDictionary
    {
        static void Main8(String[] args)
        {
            ...
            foreach (var element in a)
            {
                ...
                var expandedHeap = ExpandHeap(heap);
                
                Console.WriteLine(CalculateMedia(expandedHeap).ToString("F1"));
            }
        ...
        private static List<int> ExpandHeap(SortedDictionary<int, int> heap)
        {
